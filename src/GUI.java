...
public abstract class GUI {
	...
	/**
	 * Is called every time the user clicks the "Add light source" button.
	 * It adds a new light source to the scene.
	 */
	protected abstract void addNewLight();

	/**
	 * Is called every time the user clicks the "Remove light source button.
	 * Removes the most recently added light source from the scene.
	 */
	...
	private void initialise() {
		...
		ChangeListener ambientLightListener = new ChangeListener() {
			@Override
		...
		red.addChangeListener(ambientLightListener);

		green.setBackground(new Color(50, 230, 50));
		green.addChangeListener(ambientLightListener);

		blue.setBackground(new Color(50, 50, 230));
		blue.addChangeListener(ambientLightListener);
		...
		JButton addLight = new JButton("Add light source");
		...
		JPanel addLightPanel = new JPanel(new BorderLayout());
		addLightPanel.setMaximumSize(new Dimension(1000, 25));
		addLightPanel.setPreferredSize(new Dimension(1000, 25));
		addLightPanel.add(addLight, BorderLayout.CENTER);

		JButton removeLight = new JButton("Remove light source");
		...
		JPanel removeLightPanel = new JPanel(new BorderLayout());
		removeLightPanel.setMaximumSize(new Dimension(1000, 25));
		removeLightPanel.setPreferredSize(new Dimension(1000, 25));
		removeLightPanel.add(removeLight, BorderLayout.CENTER);
		...
		controls.add(addLightPanel);
		controls.add(removeLightPanel);
